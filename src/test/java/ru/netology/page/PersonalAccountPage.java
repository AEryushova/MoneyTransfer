...
public class PersonalAccountPage {
    ...
    public TransferMoneyPage selectCardToTransfer(DataHelper.CardsInfo cardsInfo) {
        cards.findBy(text(cardsInfo.getCardNumber().substring(15))).$("[data-test-id='action-deposit']").click();
